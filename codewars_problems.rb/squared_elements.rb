...
approach:
  - square every integer in a
  - sort a and b and compare

algorithm:
  - iterate through each integer in a and return it's square
  - sort a and sort b and compare

=end
def comp(a, b)
  return false if a.nil? || b.nil?
  squared_a = a.map { |num| num**2 }
